...
Elm.PersonalSite = Elm.PersonalSite || {};
Elm.PersonalSite.make = function (_elm) {
   "use strict";
   _elm.PersonalSite = _elm.PersonalSite || {};
   if (_elm.PersonalSite.values) return _elm.PersonalSite.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   return _elm.PersonalSite.values = {_op: _op,main: main};
};
