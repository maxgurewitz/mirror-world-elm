...
Elm.App.View.make = function (_elm) {
   ...
   var subView = F3(function (address,index,model) {
      ...
      var backgroundImageArgs = A2($String.join,", ",_U.list(["to bottom right",primaryColor,A2($Basics._op["++"],secondaryColor," 70%")]));
      ...
      {ctor: "_Tuple2",_0: 0,_1: 0})) ? A2($Basics._op["++"],defaultSubViewContents,_U.list([mouseTracker])) : defaultSubViewContents;
      return A2($Html.div,
